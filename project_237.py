    ...
    def _Radar_callback(radar_data):
        ...
        for detection in radar_data:
            ...
            if prediction == 1:
                ...
                time.sleep(10)
                print("Your model took decision to go LEFT since prediction is 1")
                break
                ...
                dropped_vehicle.apply_control(carla.VehicleControl(throttle=0.5))
                time.sleep(10)
                print("Your model took decision to go RIGHT since prediction is 0")
                break


            else:
                dropped_vehicle.apply_control(carla.VehicleControl(throttle=0.5))
                print("Your model took decision to go straight since prediction is 2")
                break
